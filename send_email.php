...
<?php 
    ...
    var_dump($_POST);
        ...
        $mail = new PHPMailer(true);                            
            ...
            //Send Email
            $mail->setFrom('carizzacoleanescoto@gmail.com');
        ...
        //Recipients
            ...
            $mail->Body    = "<b> Hello, "  . $row['last_name'] . ", " . $row['first_name'] . " " . $row['middle_name'] .
            "</b><br><br> Here are your exam credentials. <br><br> Email: " . $row['email']. "<br>Password: <b>" . $row['password']. "</b>" ;
